...
### TODO: Add a user whitelist, both to who can summon the bot and whose names are generated by the bot. (remove lines posted by an individual user)
### TODO: Send user IDs to the API.
### TODO: Hide output by default.
